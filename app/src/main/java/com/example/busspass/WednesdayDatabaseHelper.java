...
public class WednesdayDatabaseHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME="Wednesday.db";
    public static final String TABLE_NAME= "WednesdayList_table";
    ...
    public WednesdayDatabaseHelper(Context context) {
