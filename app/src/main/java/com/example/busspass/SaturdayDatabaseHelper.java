...
public class SaturdayDatabaseHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME="Saturday.db";
    public static final String TABLE_NAME= "SaturdayList_table";
    ...
    public SaturdayDatabaseHelper(Context context) {
