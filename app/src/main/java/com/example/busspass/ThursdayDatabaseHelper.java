...
public class ThursdayDatabaseHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME="Thursday.db";
    public static final String TABLE_NAME= "ThursdayList_table";
    ...
    public ThursdayDatabaseHelper(Context context) {
