...
public class TuesdayDatabaseHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME="Tuesday.db";
    public static final String TABLE_NAME= "TuesdayList_table";
    ...
    public TuesdayDatabaseHelper(Context context) {
