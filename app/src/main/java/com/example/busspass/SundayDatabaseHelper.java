...
public class SundayDatabaseHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME="Sunday.db";
    public static final String TABLE_NAME= "SundayList_table";
    ...
    public SundayDatabaseHelper(Context context) {
