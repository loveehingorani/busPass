...
public class MondayDatabaseHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME="Monday.db";
    public static final String TABLE_NAME= "MondayList_table";
    ...
    public MondayDatabaseHelper(Context context) {
